...
quickAnswer:
  items:
    - strong: "Classe 1"
      text: "0 € de reste à charge (100% Santé). Appareils performants et discrets, mais moins d'options pour les environnements très bruyants et la connectivité avancée."
    - strong: "Classe 2"
      text: "1 500 à 2 000 € par oreille après remboursement. Meilleure gestion des environnements bruyants, Bluetooth complet, fonctions avancées."
  conclusion: "Le bon choix dépend avant tout de votre mode de vie, pas du prix. Voici pourquoi."
faq:
