...
<QuickAnswer>
  <ul>
    <li><strong>Classe 1</strong> : 0 € de reste à charge (100% Santé). Appareils performants et discrets, mais moins d'options pour les environnements très bruyants et la connectivité avancée.</li>
    <li><strong>Classe 2</strong> : 1 500 à 2 000 € par oreille après remboursement. Meilleure gestion des environnements bruyants, Bluetooth complet, fonctions avancées.</li>
  </ul>
  <p>Le bon choix dépend avant tout de votre mode de vie, pas du prix. Voici pourquoi.</p>
</QuickAnswer>
...
<LocalAnnuaireCTA
  titre="Testez les deux classes avant de choisir"
  description="La règle d'or : essayez un Classe 1 ET un Classe 2 pendant la période d'essai légale. Seul un audioprothésiste indépendant vous proposera les deux sans pression commerciale."
