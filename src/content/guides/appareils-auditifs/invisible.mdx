...
<LocalAnnuaireCTA
  titre="Votre conduit permet-il un invisible ?"
  description="Seul un examen du conduit auditif (otoscopie) par un audioprothésiste DE peut confirmer si un IIC ou un CIC est envisageable pour vous. Rendez-vous dans un centre indépendant pour un bilan gratuit."
