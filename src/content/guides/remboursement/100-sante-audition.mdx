...
metaTitle: "100% Santé audition 2026 : conditions, appareils"
metaDescription: "100% Santé audition : conditions, appareils éligibles, reste à charge zéro, démarches. Audioprothésiste DE, 28 ans d'expérience terrain."
...
readingTime: 9
quickAnswer:
  title: "100% Santé audition : les règles en 3 points"
  items:
    - strong: "Reste à charge 0 € :"
      text: "appareils Classe 1 plafonnés à 950 € par oreille, intégralement remboursés (240 € Sécu + complément mutuelle responsable). Aucun frais pour vous."
    - strong: "Conditions :"
      text: "ordonnance ORL obligatoire + mutuelle responsable (c'est le cas de 95 % des contrats). Renouvellement possible tous les 4 ans avec prise en charge identique."
    - strong: "Qualité :"
      text: "les appareils Classe 1 ne sont PAS bas de gamme. Minimum 12 canaux, antibruit, antilarsen, 3 programmes. Phonak Audéo L30, Signia Motion X 1X, Oticon Ruby sont d'excellents choix."
  conclusion: "Dans ma pratique, environ 40 % des patients trouvent une solution parfaite en Classe 1. Un bon réglage par un audioprothésiste compétent prime sur la classe de l'appareil."
relatedGuides:
  - remboursement/index
...
<LocalAnnuaireCTA
  titre="Trouvez un audioprothésiste 100% Santé près de chez vous"
  description="Tous les audioprothésistes diplômés d'État doivent proposer au moins un appareil de Classe 1 sans reste à charge. Consultez un indépendant près de chez vous pour un bilan gratuit et un devis 100% Santé."
