...
sources:
  ...
  - name: "Ministère de la Santé - 100% Santé"
    url: "https://solidarites-sante.gouv.fr/"
  - name: "DREES - Comptes de la santé 2024"
    url: "https://drees.solidarites-sante.gouv.fr/"
faq:
  - question: "Le 100% Santé audition, c'est vraiment gratuit ?"
    answer: "Oui, à condition de choisir un appareil de Classe 1 et de disposer d'une mutuelle responsable (plus de 95 % des contrats en France). Le prix est plafonné à 950 euros par oreille, intégralement couvert par la Sécurité sociale (240 euros sur une base de remboursement de 400 euros) et votre complémentaire (710 euros)."
  - question: "Quels sont les appareils concernés par le 100% Santé ?"
    answer: "Les appareils de Classe 1, aussi appelés panier RAC 0 (reste à charge zéro). Ils comprennent des contours d'oreille, des micro-contours et des intra-auriculaires avec au minimum 12 canaux de réglage, un système anti-bruit et la connectivité sans fil."
  - question: "Faut-il une ordonnance pour bénéficier du 100% Santé auditif ?"
    answer: "Oui, une ordonnance d'un médecin ORL ou d'un médecin généraliste est obligatoire. Elle doit dater de moins d'un an au moment de l'appareillage. Un audiogramme complet est réalisé lors de la consultation ORL."
  - question: "Peut-on renouveler ses appareils auditifs en 100% Santé ?"
    answer: "Oui. Le renouvellement est possible tous les 4 ans, avec une nouvelle ordonnance. Si votre perte auditive évolue significativement, un renouvellement anticipé peut être accepté sur justification médicale."
  - question: "Mon audioprothésiste peut-il refuser le 100% Santé ?"
    answer: "Non. Tout audioprothésiste a l'obligation légale de vous proposer au minimum un appareil de Classe 1 avant de présenter des appareils de Classe 2. Si ce n'est pas le cas, vous pouvez le signaler à l'Assurance maladie ou consulter un autre professionnel."
  - question: "Le 100% Santé, c'est la même chose que la CMU ?"
    answer: "Non. Le 100% Santé s'adresse à tous les assurés sociaux disposant d'une mutuelle responsable, sans condition de revenus. La CMU-C (devenue Complémentaire santé solidaire) est réservée aux personnes à faibles revenus. Les deux dispositifs peuvent se cumuler, mais ce sont des mécanismes distincts."
---
...
Pour une vue complète du remboursement, consultez notre [guide complet du remboursement des appareils auditifs](/guides/remboursement/).

## Trois erreurs que je corrige chaque semaine en cabinet

**Erreur n&deg;1 : « 100% Santé = bas de gamme »**
...
**Erreur n&deg;2 : « Je n'y ai pas droit, je ne suis pas à la CMU »**
...
**Erreur n&deg;3 : « Mon audioprothésiste ne m'en a pas parlé, donc ça n'existe pas pour mon cas »**
...
**Limite n&deg;1 : Les situations d'écoute complexes**
...
**Limite n&deg;2 : La connectivité avancée**
...
**Limite n&deg;3 : L'esthétique et le confort**
...
Pour un comparatif détaillé entre les deux classes, consultez notre guide [Classe 1 vs Classe 2 : comment choisir](/guides/appareils-auditifs/classe-1-vs-classe-2/).

## Mes positions sur le 100% Santé : ce que je pense vraiment

**Position n&deg;1 : La réforme est une réussite, mais la communication est un échec.**
...
**Position n&deg;2 : Les audioprothésistes qui « oublient » de présenter le Classe 1 me posent un problème déontologique.**
...
**Position n&deg;3 : Le cahier des charges Classe 1 mériterait d'être relevé.**
