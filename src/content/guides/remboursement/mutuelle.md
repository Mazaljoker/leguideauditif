...
sources:
  ...
  - name: "DREES - Les contrats de complémentaire santé"
    url: "https://drees.solidarites-sante.gouv.fr/"
faq:
  - question: "Ma mutuelle prend-elle en charge les appareils auditifs ?"
    answer: "Toute mutuelle responsable couvre les appareils Classe 1 à 100 % (reste à charge zéro). Pour la Classe 2, le niveau de remboursement dépend de votre contrat : de 100 euros à plus de 1 000 euros par oreille en complément."
  - question: "Quel est le meilleur niveau de mutuelle pour l'audition ?"
    answer: "Pour un appareil Classe 2, visez un contrat qui rembourse au minimum 500 euros par oreille en complément de la Sécurité sociale. Les contrats premium peuvent aller jusqu'à 1 200 euros par oreille."
  - question: "Existe-t-il un délai de carence pour l'audioprothèse ?"
    answer: "Certaines mutuelles imposent un délai de 6 à 12 mois avant de rembourser l'audioprothèse. Vérifiez ce point avant de souscrire si un appareillage est prévu à court terme."
  - question: "La CSS (ex-CMU-C) couvre-t-elle les appareils auditifs ?"
    answer: "Oui, la Complémentaire Santé Solidaire prend en charge les appareils Classe 1 intégralement et offre une base de remboursement pour la Classe 2."
  - question: "Peut-on changer de mutuelle pour mieux se faire rembourser ?"
    answer: "Oui, depuis la loi du 14 juillet 2019, vous pouvez résilier votre mutuelle à tout moment après un an de contrat, sans frais ni pénalités."
  - question: "Comment comparer les mutuelles pour l'audioprothèse ?"
    answer: "Comparez le remboursement en euros par oreille (pas en pourcentage), vérifiez les délais de carence, le plafond annuel, le réseau de soins et la cotisation mensuelle rapportée au gain réel."
---
...
Pour une vue d'ensemble du remboursement, consultez notre [guide complet du remboursement des appareils auditifs](/guides/remboursement/).

## Les trois erreurs que je corrige chaque semaine

**Erreur n&deg;1 : confondre pourcentage et montant réel**
...
**Erreur n&deg;2 : ne pas vérifier le délai de carence**
...
**Erreur n&deg;3 : négliger la mutuelle d'entreprise**
...
1. **La Sécurité sociale** : base de remboursement de 400 euros par appareil, remboursée à 60 %, soit **240 euros**. Ce montant est fixe, identique pour tous les assurés, que votre appareil coûte 950 euros ou 2 000 euros.

2. **Votre mutuelle** : complète tout ou partie de la différence entre le prix de l'appareil et les 240 euros de la Sécu.

C'est sur le deuxième pilier que le choix de votre contrat devient déterminant.

## Mutuelle responsable : la clé du 100% Santé

Depuis la réforme [100% Santé audition](/guides/remboursement/100-sante-audition/), les mutuelles responsables ont l'obligation de couvrir intégralement les appareils **Classe 1** (prix plafonné à 950 euros par oreille). Le cumul Sécurité sociale + mutuelle responsable aboutit à un reste à charge de **zéro euro**.
...
1. **Le montant du complément audioprothèse en euros** : c'est l'information essentielle. Pas le pourcentage, les euros.
2. **Le délai de carence** sur le poste audioprothèse
3. **Le plafond annuel** : certains contrats limitent le remboursement à un montant global par an ou par période de 4 ans
4. **Le réseau de soins** : certaines mutuelles orientent vers des audioprothésistes partenaires avec des tarifs négociés
...
- **Demandez un devis à votre audioprothésiste** en amont : il vous remettra un [devis normalisé](/guides/remboursement/devis/) indiquant le prix, la base Sécu et le reste à charge estimé. Ce document permet de comparer efficacement les mutuelles.
...
Pour aller plus loin, consultez notre [guide du remboursement des appareils auditifs](/guides/remboursement/) et notre article dédié au [100% Santé audition](/guides/remboursement/100-sante-audition/).
