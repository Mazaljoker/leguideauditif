...
sources:
  ...
  - name: "OMS - Activité physique et santé des seniors"
...
faq:
  - question: "Peut-on faire du sport avec des appareils auditifs ?"
    answer: "Oui, pour la majorité des sports. Utilisez un clip de rétention pour les activités intenses et retirez-les uniquement pour les sports aquatiques."
  - question: "Les appareils auditifs sont-ils résistants à la transpiration ?"
    answer: "La plupart ont un indice IP68, résistant aux éclaboussures et à la transpiration. Séchez-les néanmoins après une séance intense et utilisez un déshumidificateur."
  - question: "Peut-on nager avec des appareils auditifs ?"
    answer: "Non, même les appareils IP68 ne supportent pas l'immersion prolongée. Retirez-les avant la piscine, la mer ou toute activité aquatique."
  - question: "Comment fixer ses appareils pendant le sport ?"
    answer: "Des clips de rétention, bandeaux ou cordons de sécurité empêchent la chute. Ils coûtent entre 5 et 20 euros."
  - question: "Le vent gêne-t-il les appareils pendant le vélo ou la course ?"
    answer: "Les microphones peuvent capter le bruit du vent. Activez le programme 'extérieur' ou 'sport' si disponible sur votre modèle."
  - question: "Faut-il une assurance spéciale pour le sport avec des appareils auditifs ?"
    answer: "La garantie fabricant couvre généralement la casse accidentelle pendant 4 ans. Vérifiez les conditions avec votre audioprothésiste."
---
...
Pour les sportifs intensifs qui s'entraînent plusieurs fois par semaine, je recommande un [entretien professionnel](/guides/appareils-auditifs/entretien/) chez votre audioprothésiste tous les trois mois plutôt que tous les six mois. C'est un nettoyage en profondeur, avec vérification des composants, qui prend quinze minutes et qui est inclus dans votre suivi.
...
Vous trouverez un guide complet dans notre article dédié aux [accessoires pour appareils auditifs](/guides/appareils-auditifs/accessoires/).
