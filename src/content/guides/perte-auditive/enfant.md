...
readingTime: 9
image: /images/blog/enfant/enfant.webp
ogImage: /images/blog/enfant/enfant-og.webp
relatedGuides:
  - perte-auditive/index
  - perte-auditive/causes
sources:
  - name: "HAS - Évaluation du dépistage néonatal systématique de la surdité permanente bilatérale (2024)"
    url: "https://www.has-sante.fr/"
  - name: "INSERM - Surdités de l'enfant (dossier mis à jour 2024)"
    url: "https://www.inserm.fr/dossier/surdites/"
  - name: "OMS - Surdité et déficience auditive, aide-mémoire (2024)"
    url: "https://www.who.int/fr/news-room/fact-sheets/detail/deafness-and-hearing-loss"
faq:
  - question: "Comment savoir si mon bébé entend bien ?"
    answer: "Le dépistage néonatal (OEA) est réalisé à la maternité dans les 48h. À domicile, observez les réactions aux sons : sursaut au bruit fort, orientation de la tête vers votre voix, babillage vers 5-6 mois. En cas de doute, consultez un ORL pédiatrique sans attendre."
  - question: "Le dépistage néonatal est-il obligatoire en France ?"
    answer: "Oui, depuis 2012. Il est réalisé dans les 48h suivant la naissance par otoémissions acoustiques (OEA). Un résultat anormal ne signifie pas forcément surdité — un test de contrôle est toujours prévu."
  - question: "À quel âge un enfant peut-il porter un appareil auditif ?"
    answer: "Dès quelques mois de vie si nécessaire. La HAS recommande un appareillage avant 6 mois pour optimiser le développement du langage. Les contours d'oreille pédiatriques sont adaptés à la croissance du conduit auditif."
  - question: "Les appareils auditifs pour enfants sont-ils remboursés ?"
    answer: "Oui, intégralement en Classe 1 (100% Santé). Le renouvellement est possible tous les 2 ans chez l'enfant de moins de 20 ans, contre 4 ans chez l'adulte. Les embouts et piles sont également pris en charge."
  - question: "Quels sont les signes de surdité chez un enfant de 2-3 ans ?"
    answer: "Retard de langage, absence de réaction quand on l'appelle, volume TV excessif, difficulté de concentration. Attention : ces signes sont souvent confondus avec de l'inattention. Un bilan auditif devrait précéder toute hypothèse de trouble de l'attention."
---
...
Pour un panorama complet des mécanismes en jeu, consultez notre guide sur [les causes de la perte auditive](/guides/perte-auditive/causes/).
...
Pour le détail des modalités, consultez notre guide sur [le remboursement des aides auditives](/guides/remboursement/).
