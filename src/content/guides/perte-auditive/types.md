...
sources:
  ...
  - name: "HAS - Évaluation et prise en charge des surdités"
...
faq:
  - question: "Quelle est la différence entre surdité de transmission et de perception ?"
    answer: "La surdité de transmission touche l'oreille externe ou moyenne (souvent traitable). La surdité de perception touche l'oreille interne ou le nerf auditif (irréversible, appareillable). L'audiogramme les distingue en comparant conduction aérienne et osseuse."
  - question: "Quel type de perte auditive nécessite un appareil auditif ?"
    answer: "Principalement la surdité de perception et la surdité mixte. La surdité de transmission est souvent traitable médicalement ou chirurgicalement, mais un appareillage temporaire peut être proposé en attente d'intervention."
  - question: "Comment savoir quel type de perte auditive j'ai ?"
    answer: "L'audiogramme réalisé par l'ORL compare la conduction aérienne et osseuse. L'écart entre les deux courbes détermine le type de surdité. Un examen otoscopique complète le diagnostic."
  - question: "La surdité mixte est-elle fréquente chez les seniors ?"
    answer: "Oui, très fréquente après 70 ans. Elle combine presbyacousie (perception) et rigidification de la chaîne ossiculaire ou otospongiose (transmission). La prise en charge est souvent double : chirurgie et appareillage."
  - question: "Une surdité de transmission peut-elle guérir ?"
    answer: "Souvent oui : extraction de bouchon, traitement d'otite, chirurgie d'otospongiose. Le pronostic dépend de la cause identifiée par l'ORL."
---
...
- **Surdité brusque** : une perte soudaine, généralement unilatérale, qui constitue une urgence médicale. Le traitement par corticoïdes doit être administré dans les 48 heures. En savoir plus sur la [surdité brusque](/guides/perte-auditive/surdite-brusque/).
...
1. **Traiter la composante de transmission** lorsque c'est possible (chirurgie, traitement médical). Cela permet de "récupérer" une partie de l'audition et de simplifier l'appareillage.
2. **Appareiller la composante de perception** résiduelle avec des aides auditives adaptées.
...
1. **Consultez d'abord votre médecin traitant** pour obtenir une ordonnance vers un ORL. Ne sautez pas cette étape.
2. **Exigez un audiogramme complet** -- conduction aérienne ET osseuse. Si l'ORL ne fait que la conduction aérienne, demandez pourquoi.
