...
readingTime: 9
image: /images/blog/acouphenes-causes/acouphenes-causes.webp
ogImage: /images/blog/acouphenes-causes/acouphenes-causes-og.webp
relatedGuides:
  - acouphenes/index
sources:
  ...
  - name: "HAS - Prise en charge des acouphènes chroniques (2024)"
    url: "https://www.has-sante.fr/jcms/p_3512384/fr/acouphenes-chroniques"
  - name: "Baguley et al. - Lancet (2023)"
    url: "https://doi.org/10.1016/S0140-6736(23)01215-3"
faq:
  - question: "Quelle est la cause la plus fréquente des acouphènes ?"
    answer: "L'exposition au bruit et la presbyacousie sont les deux causes les plus fréquentes. Mais dans la majorité des cas cliniques, plusieurs facteurs se combinent : une fragilité cochléaire préexistante, un déclencheur ponctuel et un terrain anxieux."
  - question: "Le stress peut-il provoquer des acouphènes ?"
    answer: "Le stress ne crée pas la lésion cochléaire. Mais il amplifie massivement la perception de l'acouphène en activant le système limbique. C'est le facteur de décompensation numéro un en consultation."
  - question: "Quels médicaments provoquent des acouphènes ?"
    answer: "Les aminosides (gentamicine), le cisplatine, l'aspirine à forte dose et certains diurétiques de l'anse sont ototoxiques. Le risque dépend de la dose, de la durée et de la fonction rénale."
  - question: "Les acouphènes pulsatiles sont-ils dangereux ?"
    answer: "Les acouphènes pulsatiles, synchrones avec le pouls, justifient une consultation rapide car ils peuvent signaler un problème vasculaire. C'est le seul type d'acouphène qui correspond à un son réel mesurable."
  - question: "Un bouchon de cérumen peut-il causer des acouphènes ?"
...
Ce mécanisme explique pourquoi acouphènes et [perte auditive](/guides/perte-auditive/symptomes/) sont si étroitement liés. Selon l'INSERM, une personne sur trois de plus de 65 ans présente une presbyacousie significative. Parmi elles, près de la moitié rapporte des acouphènes associés.
...
Pour aller plus loin, consultez notre [guide complet sur les acouphènes](/guides/acouphenes/) qui détaille les options de diagnostic et de traitement, ou notre guide sur les [symptômes de la perte auditive](/guides/perte-auditive/symptomes/) si vous suspectez une baisse d'audition associée.
