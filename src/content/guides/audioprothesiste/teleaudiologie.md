...
relatedGuides:
  ...
  - audioprothesiste/suivi
sources:
  - name: "HAS - Téléaudiologie"
    url: "https://www.has-sante.fr/"
  - name: "UNSAF - Téléconsultation en audioprothèse"
    url: "https://www.unsaf.org/"
faq:
  - question: "La téléaudiologie remplace-t-elle les RDV en centre ?"
    answer: "Non, elle les complète. Les RDV en centre restent nécessaires pour l'otoscopie, l'audiogramme et les mesures in vivo. La téléaudiologie sert aux ajustements fins entre les visites."
  - question: "Comment fonctionne un réglage à distance ?"
    answer: "Via l'application de votre fabricant (myPhonak, Signia TeleCare...). L'audioprothésiste ajuste les paramètres depuis son logiciel et les envoie sur vos appareils."
  - question: "Faut-il un smartphone pour la téléaudiologie ?"
    answer: "Oui, un smartphone compatible avec l'application du fabricant est nécessaire. La connexion Bluetooth entre le téléphone et les appareils est indispensable."
  - question: "La téléaudiologie est-elle remboursée ?"
    answer: "Les réglages à distance font partie du forfait de suivi. Aucun supplément n'est facturé si votre audioprothésiste propose ce service."
  - question: "Toutes les marques proposent-elles la téléaudiologie ?"
    answer: "Les principaux fabricants (Phonak, Signia, ReSound, Oticon, Starkey) proposent tous une solution de téléaudiologie en 2026."
---
...
1. **Vous signalez un besoin** via l'application du fabricant sur votre smartphone. Certaines applications permettent un message vocal ou écrit décrivant la situation.
2. **L'audioprothésiste analyse votre demande** et consulte les données d'utilisation de vos appareils : durée de port quotidienne, environnements sonores fréquentés, programmes utilisés.
3. **Il prépare le réglage** depuis son logiciel professionnel : modification du gain, ajustement de la réduction de bruit, création d'un programme spécifique.
4. **Vous recevez le réglage** : une notification apparaît sur votre téléphone. Vous acceptez la mise à jour, les nouveaux paramètres sont transférés via Bluetooth.
5. **Vous testez et donnez un retour** dans les situations concernées.
