...
readingTime: 8
image: /images/blog/premier-rdv/premier-rdv.webp
ogImage: /images/blog/premier-rdv/premier-rdv-og.webp
relatedGuides:
  - audioprothesiste/index
  - audioprothesiste/choisir
sources:
  - name: "UNSAF - Le parcours d'appareillage"
    url: "https://www.unsaf.org/"
  - name: "HAS - Évaluation des appareils auditifs (2024)"
    url: "https://www.has-sante.fr/"
  - name: "Ameli.fr - Remboursement prothèses auditives"
    url: "https://www.ameli.fr/assure/remboursements/remboursement-dispositif-medical/protheses-auditives"
faq:
  - question: "Que faut-il apporter au premier rendez-vous ?"
    answer: "Votre ordonnance ORL de moins d'un an, votre carte vitale, votre attestation de mutuelle, votre dernier audiogramme si vous en avez un, et la liste de vos traitements en cours."
  - question: "Combien de temps dure le premier rendez-vous ?"
    answer: "Entre 45 minutes et 1 heure. C'est le rendez-vous le plus long car il inclut le bilan complet, l'anamnèse et les premiers essais."
  - question: "Peut-on venir accompagné ?"
    answer: "Oui, c'est même recommandé. Un proche peut aider à évaluer votre compréhension au quotidien et vous soutenir dans la démarche."
  - question: "Essaie-t-on les appareils dès le premier rendez-vous ?"
    answer: "Oui, dans la plupart des cas. L'audioprothésiste vous fait écouter des appareils de démonstration pour que vous perceviez immédiatement la différence."
  - question: "Le premier rendez-vous est-il payant ?"
    answer: "Non, le bilan auditif chez l'audioprothésiste est gratuit et sans engagement. Vous ne payez qu'à la livraison de l'appareil définitif."
---
...
Pour en savoir plus sur les modalités de prise en charge, consultez notre [guide remboursement](/guides/remboursement/).
