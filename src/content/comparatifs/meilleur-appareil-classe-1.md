...
products:
  - brand: Phonak
    ...
    rechargeable: true
    warrantyYears: 4
    verdict: "Meilleur rapport qualité-prix Classe 1, rechargeable"
    bestFor: "Première expérience, confort quotidien"
  - brand: Signia
    model: Pure 312 1AX
    type: RIC
    class: "1"
    ...
    rechargeable: false
    warrantyYears: 4
    verdict: "Fiable et léger, fonctionnement à piles"
  ...
  - brand: ReSound
    ...
    rechargeable: true
    warrantyYears: 4
    verdict: "Bonne qualité sonore, design compact"
    bestFor: "Utilisateurs recherchant la discrétion"
  - brand: Oticon
    model: Jet
    type: contour
    class: "1"
    ...
    rechargeable: false
    warrantyYears: 4
    verdict: "Robuste, adapté aux pertes sévères"
    bestFor: "Pertes auditives importantes"
faq:
  - question: "Les appareils Classe 1 sont-ils de bonne qualité ?"
    answer: "Oui, ils répondent à un cahier des charges exigeant : 12 canaux minimum, réduction du bruit, antilarsen, 3 programmes. La qualité est réelle pour une utilisation quotidienne."
  - question: "Peut-on avoir un appareil rechargeable en Classe 1 ?"
    answer: "Oui, certains modèles Classe 1 sont rechargeables (ex : Phonak Life L30, ReSound Key 2). Demandez à votre audioprothésiste."
  - question: "Quelle est la différence avec un appareil à 2000 euros ?"
    answer: "Principalement le Bluetooth natif, l'intelligence artificielle, le nombre de canaux et la finesse du traitement en milieu très bruyant."
  - question: "Combien d'appareils Classe 1 puis-je obtenir ?"
    answer: "Deux appareils (un par oreille) si l'appareillage binaural est prescrit par l'ORL. Le RAC zéro s'applique aux deux."
  - question: "Le Classe 1 est-il disponible en intra-auriculaire ?"
    answer: "Oui, mais le choix de modèles intra est plus restreint en Classe 1 qu'en Classe 2."
sources:
...
Pour un comparatif détaillé entre les deux classes, consultez notre [guide Classe 1 vs Classe 2](/guides/appareils-auditifs/classe-1-vs-classe-2/).
...
1. **Consultez votre médecin traitant ou un ORL** -- Une prescription médicale est obligatoire. L'ORL réalise un bilan auditif complet (audiogramme tonal et vocal) et vous délivre une ordonnance.

2. **Prenez rendez-vous chez un audioprothésiste** -- Vous êtes libre de choisir le professionnel de votre choix. L'audioprothésiste réalise un bilan approfondi et vous présente un devis détaillant les appareils de Classe 1 et de Classe 2 disponibles. Le devis normalisé est obligatoire depuis 2019 (source : Ameli.fr).

3. **Essayez pendant 30 jours** -- La loi vous garantit un essai gratuit et sans engagement de 30 jours. Portez vos appareils dans toutes vos situations de vie. Votre audioprothésiste ajuste les réglages en fonction de vos retours.

4. **Validez ou changez** -- Si les appareils vous conviennent, l'achat est finalisé. Votre reste à charge est de zéro euro. Si vous n'êtes pas satisfait, vous les rendez sans frais et pouvez essayer un autre modèle.

5. **Bénéficiez du suivi inclus** -- Votre forfait comprend 30 séances de suivi réparties sur 4 ans. Ces rendez-vous sont essentiels pour optimiser vos réglages et vérifier le bon fonctionnement de vos appareils.
...
Pour le détail complet des modalités de remboursement, consultez notre [guide 100 % Santé audition](/guides/remboursement/100-sante-audition/).
