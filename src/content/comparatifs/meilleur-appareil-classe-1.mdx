...
<LocalAnnuaireCTA
  titre="Testez ces appareils Classe 1 gratuitement"
  description="Tous les audioprothésistes DE doivent vous proposer un essai 30 jours sans engagement. Comparez les 4 modèles Classe 1 en conditions réelles chez un indépendant près de chez vous."
  villes={['Rennes', 'Strasbourg', 'Montpellier', 'Saint-Étienne']}
/>
