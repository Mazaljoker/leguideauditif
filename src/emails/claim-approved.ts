...
export function claimApprovedEmail({ prenom, centreNom, centreSlug, magicLink }: ClaimApprovedData): string {
  ...
  return emailLayout(
    ...
    <p class="text-muted">Ce lien est valable 24h. Pour vous reconnecter plus tard, rendez-vous sur <a href="https://leguideauditif.fr/connexion-pro">leguideauditif.fr/connexion-pro</a> et saisissez votre email.</p>
